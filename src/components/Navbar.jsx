                        ...
                        ulDisplay ? 'translate-x-0' : '-translate-x-full'}`}>
                            ...
                            ulDisplay ? 'translate-x-0' : '-translate-x-full'}`}>
                                ...
                                <div id="copyright" className='mt-[20px] text-[.94rem]'>
                                    &copy;2023. Hecho por <a href="https://damiantabia.vercel.app/" className='transition duration-500 hover:text-[#b29a00]'>Damián Tabia</a>.<br /> Todos los derechos reservados.
                                </div>
                            </div>
                        </div>
